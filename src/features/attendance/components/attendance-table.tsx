...
export const AttendanceTable = () => {
  ...
  const [page, setPage] = useQueryState('attendance-page', {
    defaultValue: '1',
  });
  ...
  }, [filters, pageNumber, handlePageChange]);
          ...
          <>
            ...
            <div className="flex items-center justify-between mt-4 pt-4 border-t">
              <div className="text-sm text-muted-foreground">
                Showing {total > 0 ? (pageNumber - 1) * pageSize + 1 : 0} to {Math.min(pageNumber * pageSize, total)} of {total} records
              </div>
              <div className="flex items-center space-x-2">
                ...
                <Button
                  ...
                  size="sm"
                  onClick={() => handlePageChange(pageNumber + 1)}
                  disabled={pageNumber >= Math.ceil(total / pageSize) || isLoading}
                >
                  Next
                </Button>
              </div>
