...
interface UseDownloadTodayAttendanceProps {
  teamAttendance: TeamAttendanceItem[];
  selectedDate: string;
}

export const useDownloadTodayAttendance = () => {
  const [isDownloading, setIsDownloading] = useState(false);

  const generateTeamAttendancePDF = async ({
    teamAttendance,
    selectedDate,
  }: UseDownloadTodayAttendanceProps) => {
    try {
  ...
  const downloadTodayAttendance = async ({
    teamAttendance,
    selectedDate,
  }: UseDownloadTodayAttendanceProps) => {
  ...
  return { downloadTodayAttendance, generateTeamAttendancePDF, isDownloading };
};
